...
В данном примере показано как добавлять рисунки из pandas c добавлением
панели инструментов для навигации из библиотеки matplotlib для масштабирования
и перемещения рисунка в окне, а также для настройки рисунка и его сохранения
