...
В данном примере выводятся на график две линии (можно и больше)
"""
import sys
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.graph_widget.addLegend(offset=(30, 30))  # добавление условных обозначений на холст
        ...
        self.plot(hour, temperature_2, 'Sensor1', 'b')

    def plot(self, x: list, y: list, plotname: str, color: str) -> None:
        pen = pg.mkPen(color=color, width=5, style=QtCore.Qt.DashLine)  # создание пера для рисования
        ...
        self.graph_widget.plot(x, y, name=plotname, pen=pen, symbol='+', symbolSize=10, symbolBrush=color)
