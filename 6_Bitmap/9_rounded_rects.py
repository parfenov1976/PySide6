...
Пример рисования прямоугольников c закруглением на углах.
"""
import sys
...
class MainWindow(QMainWindow):
    ...
    def draw_something(self) -> None:
        ...
        painter.drawRoundedRect(40, 40, 150, 150, 10, 10, mode=Qt.RelativeSize)  # рисование прямоугольника по точки
        # лву, размерам по Х и У и закруглением по Х и У. Если указать в аргументах mode=Qt.RelativeSize, то радиус
        # закругления будет задан в количестве сотых долей (процентов) длин соответствующих сторон прямоугольника
