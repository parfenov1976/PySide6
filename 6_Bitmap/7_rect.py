...
Пример рисования прямоугольников с использованием настроек пера (размер и цвет).
"""
import sys
...
class MainWindow(QMainWindow):
    ...
    def draw_something(self) -> None:
        ...
        painter.drawRect(50, 50, 100, 100)  # рисование прямоугольника по точки лву и размерам по Х и У
