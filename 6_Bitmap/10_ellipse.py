...
class MainWindow(QMainWindow):
    ...
    def draw_something(self) -> None:
        ...
        painter.drawEllipse(10, 10, 100, 100)  # рисование эллипса, первые два числа - это координаты Х и У ЛВУ
        # прямоугольника, в который вписан эллипс, вторые числа - ширина и высота
