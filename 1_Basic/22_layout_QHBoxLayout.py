"""
Пример использования виджета слоев с горизонтальным расположением виджетов.
Размещение нескольких виджетов, заполнение слева на право.
"""
import sys
...
класса основного окна QMainWindow, класса слоев QHBoxLayout, класса пустого, базового виджета QWidget
...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.layout = QHBoxLayout()  # создание экземпляра класса слоя
