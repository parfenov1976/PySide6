...
class MainWindow(QMainWindow):
    ...
    def button_clicked(self) -> None:
        ...
        :return: None
        """
        button = QMessageBox.question(self, 'Question dialog', 'The longer message')  # создание диалогового окна
        # с вопросом из набора встроенных методов класса диалоговых окон с уведомлениями
