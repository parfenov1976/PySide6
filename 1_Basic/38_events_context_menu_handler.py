"""
Пример реализации контекстного меню с помощью специального обработчика событий contextMenuEvent
класса основных окон QMainWindow.
"""
import sys
...
class MainWindow(QMainWindow):
    ...
    def contextMenuEvent(self, event: QMainWindow.contextMenuEvent) -> None:
        """
        ...
        context.exec(event.globalPos())  # запуск цикла событий контекстного меню
