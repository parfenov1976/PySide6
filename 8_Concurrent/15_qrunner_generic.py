...
В данном примере представлен универсальный рабочий поток, который
принимает не только аргументы, но и функцию (в качестве аргумента)
с кодом для исполнения.
"""
import sys
import time
import traceback
...
class MainWindow(QMainWindow):
    ...
    def oh_no(self) -> None:
        ...
        :return: None
        """
        worker = Worker(execute_this_fn, 2)  # создание экземпляра рабочего потока с передачей ему функции для исполнения
