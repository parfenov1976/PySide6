...
Модель QSqlRelationalTableModel в данном примере «не знает», как перевести введенное название
категории в ее идентификатор, который и хранится в поле category таблицы good.
...
Решение данной проблемы представлено в следующем примере sql_relational_table_delegate_24_4_4.py
"""
