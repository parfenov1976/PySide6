"""
Пример 5 использования UI файла из QtDesigner - преобразование файла формы UI в модуль на питоне с последующим импортом
...
class MyWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.setupUi(self)  # метод для инициализации загруженной формы из супер класса Ui_MainWindow
        self.btnQuit.clicked.connect(quit)  # создание сигнала для кнопки загруженной формы с привязкой встроенной
        # команды на выход
