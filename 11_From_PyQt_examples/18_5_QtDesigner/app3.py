"""
Пример 3 использования UI файла из QtDesigner - использование функции loadUiType() загрузчика форм
"""
...
class MyWindow(QMainWindow, Form):
    """
    Класс главного окна приложения от супер класса главных окон и класса формы
    """
    def __init__(self):
        """
        ...
        self.setupUi(self)  # метод для инициализации загруженной формы
