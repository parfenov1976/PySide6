...
Пример использования запросов для подключения к базе данных и передачи этого подключения
в модель таблицы с помощью класса модели запросов QSqlQueryModel.
Таблицу, созданную запросом, нельзя редактировать в представлении.
"""
...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        query = QSqlQuery("SELECT Name, Composer FROM track", db=db)  # создание подключения к базе данных
        # с помощью запроса (взять Name и Composer из таблицы track)
