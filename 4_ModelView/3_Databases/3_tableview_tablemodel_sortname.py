...
Пример применения сортировки к таблице. Выбор столбца для сортировки по его имени
"""
...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        idx = self.model.fieldIndex('Milliseconds')  # выбор столбца по его заголовку
        self.model.setSort(idx, Qt.DescendingOrder)  # сортировка таблицы по выбранному столбцу по убыванию
