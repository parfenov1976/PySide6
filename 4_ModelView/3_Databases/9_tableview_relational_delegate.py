...
модели связанных таблиц QSqlRelationalTableModel и делегата элемента модели QSqlRelationalDelegate,
который позволяет изменять данные в полях с данными из связанных таблиц в пределах значений из
колонки связанной таблицы (выбор вариантов в выпадающем меню).
Значение меняется в таблице, выбранной в модели для отображения, а не в полях связанной таблицы.
"""
...
таблицами QSqlRelation, класса делегата элемента модели QSqlRelationalDelegate.
"""
...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        # tag:: relational delegate
        delegate = QSqlRelationalDelegate(self.table)  # создание экземпляра делегата элемента модели
        self.table.setItemDelegate(delegate)  # привязка делегата к таблице
        # end:: relational delegate
