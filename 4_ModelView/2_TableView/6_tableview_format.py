"""
Пример использования модели таблиц и представления QTableView. С примером покраски фона
в зависимости от величины содержимого ячейки (типа условное форматирование в эксель).
"""
